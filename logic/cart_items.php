      ...
      if (isset($cartItems)) {
        if ($cartItemCount <= 0)
          echo ("<h5 class='grey-text page-title'>Your shopping cart is empty.</h5><h6 class='grey-text page-title'>
              <a href='product-catalogue.php?query='>Shop Now!</a></h6>");
        ...
        <form action="payment.php" method="GET">
          <table class="responsive-table">
            <tbody>
              ...
              if ($displayShipping === 0) $displayShipping = "<span class='underline'>Kyats$displayShipping</span>";
              else $displayShipping = "Kyats$displayShipping";

              if ($sumTotal >= 2000) {
                $shippingTotal = $sumTotal - 100;
                $displayPVoucher = "<span class='underline'>-Kyats100</span> <span class='yellow-text'>(Promo voucher applied)</span>";
              ...
              echo ("<tr><th>Sum Total:</th><td>Kyats$sumTotal</td></tr>");
