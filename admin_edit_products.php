...
<body>
  <div class="rounded-card-parent container" style="margin-top: 150px">
    <div class="card rounded-card">
      <a class="btn blue darken-2" href='admin_manage_products.php' style="margin-bottom: 10px;">
        < BACK TO MANAGE PRODUCTS</a>
              ...
              <div class="col s6" style="padding-right: 40px;">
                <div class="row">
                  <div class="input-field white-text">
                    ...
                    <input name="name" id="name" type="text" class="validate white-text" value="<?php echo $name; ?>">
                ...
                <div class="row">
                  <div class="input-field white-text">
                    ...
                    <input name="brand" id="brand" type="text" class="validate white-text" maxlength="20" value="<?php echo $brand; ?>">
              ...
              <div class="col s6" style="padding-right: 40px;">
                <div class="row">
                  <div class="input-field white-text">
                    ...
                    <select name="category" id="category">
                      ...
                      <option value=1> Gym Clothes</option>
                ...
                <div class="row">
                  <div class="input-field white-text">
                    ...
                    <input name="sellingprice" id="sellingprice" type="number" step=".01" class="validate white-text" maxlength="30" value="<?php echo $sellingprice; ?>">
                ...
                <div class="row">
                  <div class="input-field white-text">
                    ...
                    <input name="quantityinstock" id="quantityinstock" type="number" class="validate white-text" maxlength="30" value="<?php echo $quantityinstock; ?>">
            ...
            <div class="row">
              <div class="file-field col s6">
                ...
                <div class="file-path-wrapper">
                  <input name="image" id="product_image" class="file-path validate white-text" type="text" onchange="update_image(this)" value="<?php echo $image; ?>">
                </div>
              </div>
