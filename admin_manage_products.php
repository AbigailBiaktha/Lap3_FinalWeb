...
<head>
  ...
  <title>Manage Products Panel</title>
  <?php
            ...
            <table class="responsive-table" id="pagination">
              <thead class="text-primary">
                <tr>
                  <th>Name</th>
                  <th>Brand</th>
                  <th class='center'>Quantity In Stock</th>
                </tr>
              </thead>
              <tbody>
                <?php
            ...
            <div class="row">
              <div class="file-field col s6">
                ...
                <div class="file-path-wrapper">
                  <input name="image" id="product_image" class="file-path validate white-text" type="text" placeholder="Choose Image" onchange="update_image(this)">
                </div>
              </div>
