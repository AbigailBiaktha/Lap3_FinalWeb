      ...
      <div class="card rounded-card">
        ...
        <div class="row">
          <div class='col s4 center'>
            <img class="shadow-img" src="product_images/<?php echo ($image); ?>" style="max-height: 300px; max-width: 300px;">
          </div>
          ...
          <div class="row">
            <div class="input-field col s12 white-text">
              ...
              <textarea id="review" class="materialize-textarea white-text" data-length="250" name="review"><?php echo (checkReviewExists($conn, $orderItemID)); ?></textarea>
            </div>
            <div class="errormsg">
              <?php
              if (isset($_GET["error"])) {
