...
<body>
  <div class="container">
    <div class="col s12" style="margin-bottom: 50px;">
      <?php include "./logic/cart_items.php"; ?>
    </div>
    <div class="selectable-card grey darken-4" id="no-hover">
      ...
      <form class="row white-text" action="payment.php?order_id=<?php echo ($_GET["order_id"]) ?>&member_id=<?php echo ($_GET["member_id"]) ?>&view_order=1" method="POST" style="margin-left: 50px;">
        <div class="col s8">
          <div class="row">
          ...
          <div class="row">
            <div class="input-field">
              ...
              <textarea placeholder="House No, Street, District, Zip, State" id="home" class="materialize-textarea white-text" name="address" type="text" class="validate white-text"></textarea>
...
if (isset($_POST["payment"])) {
  ...
  if (isset($_GET["order_id"])) {
    ...
    $conn->conn()->query($sql) or die($conn);
