<?php
  ...
  const CATEGORY_NAMES = ["Mat", "Gym Clothes", "Equipment"];
  const BRAND_NAMES = ["Nike", "Adidas", "Puma", "Under Armour", "Reebok", "New Balance", "Fila", "Converse", "Vans"];
  ...
  function generateItemList($items){
    ...
    while ($itemIdx < $itemCount) {
      ...
      for ($i=0; $itemIdx < $itemCount && $i < 4; $itemIdx++){
        ...
        $price = "Kyats" . number_format($price, 2);
