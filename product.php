...
<head>
  ...
  ?>
  <title>Products Categories<?php echo htmlspecialchars($name) ?></title>
</head>
...
<body>
  ...
  if (isset($_GET["item_id"])) {
    ...
    $displayPrice = "Kyat" . number_format($price, 2);
  ...
  <div class="container" style="margin-top: 50px;">
    <div class="rounded-card-parent">
      <div class="card rounded-card">
        <a class="btn red darken-2" href="product-catalogue.php" style='margin-left: 20px'>
          < BACK TO CATALOGUE</a>
              ...
              <div class="row">
                <div class="col s4">
                  <a class="magnifier-thumb-wrapper demo">
                    <img id="thumb" style="max-height: 350px; max-width: 350px; margin-top: 30px" src="product_images/<?php echo ($image); ?>" data-large-img-url="product_images/<?php echo ($image); ?>" data-large-img-wrapper="preview">
                  </a>
                ...
                <div class="col s8">
                  <div class="row">
                    <table class="responsive-table">
                      <tbody>
                        <tr>
                          <h4 class="white-text"><?php echo ($name); ?></h4>
                        </tr>
                        <tr>
                          <!-- product details -->
                          <?php
                        ...
                        <tr>
                          <th class='grey-text'>Category: </th>
                  ...
                  <div class="row input-field grid">
                    ...
                    <button type="button" class="btn-small waves-effect waves-light red" onclick="subtractQty()">
                      <i class="material-icons">remove</i>
                    </button>

                    <input id="qty" class="white-text" type="number" disabled style="padding: 10px; width: 5%;" value=0></input>
                    <input id="sync-qty" name="qty" class="white-text" type="hidden" value=0></input>

                    <button type="button" class="btn-small waves-effect waves-light green" onclick="addQty()">
...
<script type="text/javascript" src="assets/js/product_page.js"></script>
